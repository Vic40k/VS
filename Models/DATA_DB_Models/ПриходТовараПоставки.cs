...
{
    public partial class ПриходТовараПоставки
    {
        public ПриходТовараПоставки()
        {
            РасходТовараПоставки = new HashSet<РасходТовараПоставки>();
        }
        ...
        public virtual ICollection<РасходТовараПоставки> РасходТовараПоставки { get; set; }
    }
}
