...
{
    public partial class TestПриходТовараПоставки
    {
        public TestПриходТовараПоставки()
        {
            TestРасходТовараПоставки = new HashSet<TestРасходТовараПоставки>();
        }
        ...
        public virtual ICollection<TestРасходТовараПоставки> TestРасходТовараПоставки { get; set; }
    }
}
