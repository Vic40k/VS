...
{
    public partial class ПечатьВыдатковойDb
    {
        ...
        public double? ВнешнийНомер { get; set; }
        ...
        public DateTime ДатаСч { get; set; }
